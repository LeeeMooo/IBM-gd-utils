...
const { tg_token, book_marks  } = AUTH
...
module.exports = { send_count, send_help, sm, extract_fid, reply_cb_query, send_choice, send_task_info, send_all_tasks, tg_copy, extract_from_text, get_target_by_alias, send_bm_help, send_all_bookmarks, set_bookmark, restore_bookmark, unset_bookmark, clear_tasks, send_task_help, rm_task }
